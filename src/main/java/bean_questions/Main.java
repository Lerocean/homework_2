...
import bean_questions.service.AnotherServiceImpl;
...
public class Main {
    public static void main(String[] args) {
        ...
        AnotherServiceImpl anotherServiceImpl = context.getBean(AnotherServiceImpl.class);
        anotherServiceImpl.sayGreeting();
        anotherServiceImpl.sayFarewell();
    }
}